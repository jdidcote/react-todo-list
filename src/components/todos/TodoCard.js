    ...
    <div className="border-2 flex-col border-black p-2 rounded-lg my-3">
      ...
      <div className="flex flex-row justify-between text-slate-500">
        ...
        <label className="inline-flex relative items-center mr-5 cursor-pointer">
          ...
          />
          <div className="w-11 h-6 bg-gray-200 -z-10 rounded-full peer dark:bg-gray-700 peer-focus:ring-4 peer-focus:ring-green-300 dark:peer-focus:ring-green-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600"></div>
          <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300 -z-10">
